			...
			<div className='bg-white bg-opacity-90 p-8 rounded-xl shadow-2xl w-full max-w-4xl space-y-6'>
				...
				<div className='flex flex-col md:flex-row gap-6'>
					<div className='flex-1 p-4 border border-gray-300 rounded-lg'>
						...
						<p className='text-gray-800'>
							<span className='font-semibold'>Pickup Sign:</span>{' '}
							{userDetails.pickupSign || 'N/A'}
						</p>
						<p className='text-gray-800'>
							<span className='font-semibold'>Notes for Chauffeur:</span>{' '}
					...
					<div className='flex-1 p-4 border border-gray-300 rounded-lg'>
						...
						<p className='text-gray-800'>
							<span className='font-semibold'>Booking Reservation:</span>{' '}
							{reservationNumber}
						</p>
						<p className='text-gray-800'>
				...
				<div className='p-4 border-t border-gray-300 mt-6'>
					...
					<ul className='list-disc list-inside text-gray-700 mt-2'>
						<li>
							Please contact the Ace Taxi helpline if you want to cancel, make
							changes, or pay with your credit or debit card.
						</li>
						<li>
							For address pickups, the driver will meet you at the front of the
							door or at the nearest parking spot in case of any parking
							restrictions.
						</li>
					</ul>
				</div>
				...
				<div className='flex space-x-4 mt-8'>
					<button
						...
						className='flex-1 bg-gradient-to-r from-sky-600 to-blue-600 text-white py-3 rounded-lg hover:from-sky-700 hover:to-blue-700 transition-all duration-300 shadow-lg'
					>
						Print
					</button>
					<button
						onClick={handleFinish}
						className='flex-1 bg-gradient-to-r from-green-600 to-green-500 text-white py-3 rounded-lg hover:from-green-700 hover:to-green-600 transition-all duration-300 shadow-lg'
					>
						Finish
					</button>
				</div>
